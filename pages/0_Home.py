...
tiles = [
    ...
    ("🆚", "Matchup Analysis", "H2H history · Rolling win-rate charts", "pages/4_Matchup_Analysis.py"),
    ...
    ("🎯", "Betting Recommendations", "All game recommendations", "pages/9_Betting_Recommendations.py"),
